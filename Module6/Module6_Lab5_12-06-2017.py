...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov  6 20:35:27 2017
...
print("After dropping all rows with any NaNs, shape of X is:" + str(X.shape))
...
print("High-Dimensionality Score: " + str(round((score*100), 3)))
